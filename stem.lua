...
logo.Image = "http://www.roblox.com/asset/?id=18763630813"
...
--// Load Key \\--
if isfile("926958") then
    local key = readfile("926958")
    Notify({
